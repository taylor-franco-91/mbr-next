                ...
                {ctaLabel && ctaHref && (
                    <div className="mt-6">
                        <Link
                            ...
                            className="inline-flex items-center justify-center rounded-xl px-4 py-2 text-sm font-semibold bg-orange-600 hover:bg-orange-700 text-white hover:opacity-90 active:scale-[.98]"
                        >
                            {ctaLabel}
                        </Link>
                    </div>
